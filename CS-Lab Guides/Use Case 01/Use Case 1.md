...
- **Workspace name** – Enter +++SQLDatabase-09+++
...
**Important Note: Please refresh the browser before you move to next
step.**
...
4.  Choose whatever **resource group** is available in the dropdown
    list.

    ![A screenshot of a computer Description automatically
    generated](./media/image53.png)

5.  Provide a name to Azure OpenAI as +++azure-openai-test09+++
...
20. Keep the deployment name as it is (**text-embedding-ada-002**) and
