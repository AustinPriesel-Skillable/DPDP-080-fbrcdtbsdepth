...
2.  You'll see a **Loading Sample Data** notification.
    ...
    **Note:** Don't modify the database while the import is in process.
...
3.  Once complete, there's a notification. The object explorer also
    refreshes to show the new **SalesLT** schema under the sqldb
    database. You're now ready to get started with
    the AdventureWorksLT sample database.

    ![A screenshot of a computer Description automatically
    generated](./media/image25.png)

4.  Expand the **SalesLT \> Tables** schema in the **Object
    Explorer** to see the objects that were created. Select on any of
    the tables to quickly view the data.

    ![A screenshot of a computer Description automatically
    generated](./media/image26.png)

5.  For more options, like **select top 1000 rows** or to script an
    object out, right-click or select the context menu (...) of the
    object name.
...
3.  If the **Object Explorer** is already expanded to show tables, it
    will automatically refresh to show the new ‘**Product’** table
    created under the SalesLT schema. If not, expand the tree to see the
    new table.
...
3.  Press **Enter** key so that the Copilot will generate a suggested
    T-SQL script based on the prompt.

    ![A screenshot of a computer Description automatically
    generated](./media/image35.png)

4.  Now, Press the **Tab** key to accept Copilot's suggestion. It should
...
5.  Select the **SQL analytics endpoint** from the dropdown in the SQL
    query editor. (**Note**: Refresh the page if the SQL analytics
    endpoint is disabled.)

    ![A screenshot of a computer Description automatically
    generated](./media/image42.png)

6.  You now see that the **Object Explorer** changed over to the
    warehouse experience.

    ![A screenshot of a computer Description automatically
    generated](./media/image43.png)

7.  Select **Address** table under the **SalesLT** database to see the
...
10. **The query will automatically run**. You’ll see the top 100 rows of
...
1.  Navigate to **sqldb** database from the top navigation tab.
...
3.  Enter the **Name API for GraphQL** as **+++sqldb_api+++** and
    ...
    At this point, the API is ready but it's not exposing any data. APIs
    for GraphQL are defined in a schema organized in terms of types and
    fields, in a strongly typed system. Fabric automatically generates the
    necessary GraphQL schema based on the data you choose to expose to
    GraphQL clients.
...
6. To add data to the API for GraphQL, click on **Select data source**.
...
9. In the Choose data tab, select **Address**, **SalesOrder**,
    **Customer** and **Product** tables of the **SalesLT** schema and
...
10. The schema is generated, and you can start prototyping GraphQL
    ...
    interact with your data. The below image shows the **Schema
...
2.  Select the **New Semantic Model** option from the **Home** tab.

    ![A screenshot of a computer Description automatically
    generated](./media/image60.png)

3.  Pick all the tables under **SalesLT** and **dbo** schema by clicking
    on the **SalesLT** and **dbo** checkboxes. You can change the picked
    tables later.
...
4.  Also, provide a name to the semantic model as +++**sqldb-model**+++
    and click on confirm to proceed.

    ![A screenshot of a computer Description automatically
    generated](./media/image63.png)

5.  If the **Power BI** window prompted, enter the email id and click on
    **Submit** button.

    ![A screenshot of a computer screen Description automatically
    generated](./media/image64.png)

6.  Once the semantic model page opens, navigate to the **Files** tab
    and select **create new report**.

    ![A screenshot of a computer Description automatically
    generated](./media/image65.png)

7.  Expand the **Customers** table, check the checkbox of the column
    **CompanyName** for the report. 

    ![A screenshot of a computer Description automatically
    generated](./media/image66.png)

8.  Notice that as soon as you select the column, the data is displaying
    on the report area. Now, select the **EmailAddress** column. You’ll
    see **EmailAddress** data is also displayed beside the CompanyName
    in the report area.

    ![A screenshot of a computer Description automatically
    generated](./media/image67.png)

9.  Now, select **FirstName** as well and see the column in the report.

    ![A screenshot of a computer Description automatically
    generated](./media/image68.png)

10. Click anywhere on the **blank area** on the report canvas to
    unselect the data on the canvas.

    ![A screenshot of a computer Description automatically
    generated](./media/image69.png)

11. Under **Visualizations**, click on the **Clustered** **Column
    chart** icon to add a **Column chart** to your report.

    ![A screenshot of a computer Description automatically
    generated](./media/image70.png)

12. On the Data pane, expand **SalesOrderDetail and** check the box next
...
13. Check the box next to **UnitPrice.**

    ![A screenshot of a computer Description automatically
    generated](./media/image72.png)

14. Check the box next to **UnitPriceDiscount**.

    ![A screenshot of a computer Description automatically
    generated](./media/image73.png)

15. Click on the **Save** button to save the report.

    ![A screenshot of a computer Description automatically
    generated](./media/image74.png)

16. Enter a name for your report as +++**sqldb_report**+++ and make sure
...
1.  In the left navigation bar, select the icon for your workspace and
    then select the workspace name again from the flyout menu which show
    all the items in the workspace.

    ![A screenshot of a computer Description automatically
    generated](./media/image77.png)

2.  From the top toolbar, select **Workspace settings**.
